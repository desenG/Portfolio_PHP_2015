...
app.controller('apiCtrl', function (customer) {
    
    window.location.href = customer.config.url;
});
  ...
  function($routeProvider) {
    $routeProvider.
      ...
      .when('/edit-customer/:customerID', {
        ...
        templateUrl: 'partials/edit-customer.php',
        controller: 'editCtrl',
        resolve: {
      ...
      .when('/api-customer/:customerID', {
        title: 'api Customers',
        templateUrl: 'services/customer?id=',
        controller: 'apiCtrl',
        resolve: {
            customer: function(services, $route){
                var customerID = $route.current.params.customerID;
